  ...
  return (
    <div className="sticky">
      <div className="border rounded-sm">
        ...
        <ScrollArea className="h-[32rem] w-full p-5 gap-3 flex-col">
        ...
        <div className="relative p-0">
          ...
          <Button onClick={handleSendMessage} className='absolute right-2 top-3 rounded-full' size='icone' variant='ghost'>
            <PaperPlaneIcon/>
          </Button>
        </div>
      </div>
